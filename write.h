...
void print_no_space(std::string a){printf("%s", a.c_str());}
...
template<class Type>
void print_no_space(std::vector<Type>& a);
template<class Type>
void print(std::vector<Type>& a){for(int i=0;i<a.size();++i)print(a[i]);}
template<class Type>
void print(std::vector<std::vector<Type> >& a){if(a.size())(a.size()==1)?print(a[0]):writeln2(a[0]);for(int i=1;i<a.size()-1;++i)writeln2(a[i]);if(a.size()>=2)print_no_space(a.back());}
template<class Type1, class Type2>
void print(std::pair<Type1, Type2>& a){print(a.first);print(a.second);}

template<class Type>
void print_no_space(std::vector<Type>& a){if(a.size())print_no_space(a[0]);for(int i=1;i<a.size();++i)print(a[i]);}
template<class Type>
void print_no_space(std::vector<std::vector<Type> >&a){for(int i=0;i<a.size()-1;++i)writeln(a[i]);if(a.size())print_no_space(a.back());}
template<class Type1, class Type2>
void print_no_space(std::pair<Type1, Type2>&a){print_no_space(a.first);print(a.second);}
...
template<class Type1, class Type2>
void read(std::pair<Type1, Type2>&a){readln(a.first, a.second);}
template<class Type>
void read(std::vector<Type> &a){if(a.size()==0){int n;read(n);a.resize(n);}for(int i=0;i<a.size();++i)readln(a[i]);}
template <class Head,class... Tail>
