...
public class J {
    ...
    long p = 31, mod = 1000003;
 
    Pair ans(char[] str, long[] pow, long[] h, int n, int m) {
        ...
        for (Entry<Long, Pair> e : q.entrySet()) {
            if (ans == null || (e.getValue().n > ans.n) || (e.getValue().n == ans.n && (e.getValue().r > ans.r))) {
                ans = e.getValue();
            }
        }
