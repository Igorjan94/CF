...
public class Validate {
	...
	public void run() {
		...
		int cnt = inf.nextInt();
		ensureLimits(cnt, 1, 10000, "t");
		inf.nextLine();
		for (int it = 0; it < cnt; it++) {
			int n = inf.nextInt();
			int m = inf.nextInt();
			ensureLimits(n, 1, (int)(1e+7), "n");
			ensureLimits(m, 1, (int)(1e+7), "m");
			ensure(1L * n * m > 2,"n*m > 1");
			inf.nextLine();
		}
		inf.close();
	}

	private boolean is2Pow(long t) {
		return Long.bitCount(t) == 1;
	}
