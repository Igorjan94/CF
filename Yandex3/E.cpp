...
void run()
{
    ...
    fori(3)
        forj(2)
            a[3][j] += a[i][j],
            a[i][j] *= 4;
    if (orientation(a[0][0], a[0][1], a[1][0], a[1][1], a[2][0], a[2][1]) == -1)
        swap(a[0], a[1]);
    int q = orientation(a[0][0], a[0][1], a[1][0], a[1][1], a[3][0], a[3][1]);
    int w = orientation(a[1][0], a[1][1], a[2][0], a[2][1], a[3][0], a[3][1]);
    int e = orientation(a[2][0], a[2][1], a[0][0], a[0][1], a[3][0], a[3][1]);
    writeln(q + w + e == 3 ? "Standing" : q == -1 || w == -1 || e == -1 ? "Falling" : "Unstable");
}
