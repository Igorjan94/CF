...
void run()
{
    ...
    string st;
    readln(st);
    bool z = st.find('0') != string::npos;
    bool o = st.find('1') != string::npos;
    bool t = st.find('3') != string::npos;
    bool s = st.find('7') != string::npos;
    bool k = st.find('6') != string::npos;
    bool c = st.find('4') != string::npos;
    bool d = st.find('9') != string::npos;
    bool v = st.find('8') != string::npos;
    bool qwer = st.find('2') != string::npos;

    writeln((z && o || z && t || d && o || t && s || z && qwer ||
                qwer && (s || c) && d || qwer && s && (k || d) ||
                c && t && d || o && s && k) ? "YES" : "NO");
}
