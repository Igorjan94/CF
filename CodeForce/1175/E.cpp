...
#ifndef ONLINE_JUDGE
static const int N = 5 * 100 * 1000 + 10;
#else
...
void run()
{
    ...
    //fori(N) cout << i << " "; cout << "\n";
    //fori(N) cout << ends[i] << " "; cout << "\n";
    //fori(N) cout << first[i] << " "; cout << "\n";
    //fori(N) cout << dist[i] << " "; cout << "\n";
    //fori(N) cout << +ok[i] << " "; cout << "\n";
    fori(m)
    {
        readln(l, r);
        if (first[r] > l)
            ...
            writeln(max(1, dist[r] - dist[l] + 1 - ok[l]));
    }
}
