...
private fun run() {
    writeln('?', IntArray(100).indices.joinToString(" "))
    System.out.flush()
    val big = readln()[0] and (127 shl 7)
    writeln('?', IntArray(100).indices.map { (it + 1) shl 7 }.joinToString(" "))
    System.out.flush()
    val small = readln()[0] and 127
    writeln('!', big or small)
}
